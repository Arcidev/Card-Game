...
struct SpellEffectValues
{
    ...
    SpellEffectValues(uint32_t const& spellId, uint8_t const& target, uint8_t const& value1, uint8_t const& value2, uint8_t const& value3, uint8_t const& value4)
        : SpellId(spellId), Target(target), Value1(value1), Value2(value2), Value3(value3), Value4(value4) { }
};
